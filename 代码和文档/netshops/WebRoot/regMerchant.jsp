...
<FORM name=form1 onReset="return confirm('确定要清空当前表单吗？');" action=regMerchantSave.jsp         method=post target=_self>
		<table width="70%">
          
            <TR > 
              
		  <TD width="20%" align=right vAlign=top>经营项目：</TD>
            ...
            <TR > 
              ...
              <TD align=left><%= codeToString((String)session.getAttribute("userName") )%>&nbsp; <input name="userName" type="hidden" value="<%=codeToString((String)session.getAttribute("userName") ) %>"> 
              </TD>
            </TR>
            <TR > 
